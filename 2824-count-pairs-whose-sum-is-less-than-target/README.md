...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/count-pairs-whose-sum-is-less-than-target/)
...
**My Solution:** [2824-Count-Pairs-Whose-Sum-is-Less-than-Target.cpp](./2824-Count-Pairs-Whose-Sum-is-Less-than-Target.cpp)
